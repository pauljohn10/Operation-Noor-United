...
export const StationAuditPdfLayout: React.FC<Props> = ({ audit, items, prices }) => {
  ...
  return (
    ...
    >
      ...
      {/* 2. METADATA GRID (2 EQUAL COLUMNS) */}
      <div
        style={{
          display: 'flex',
          flexDirection: 'row',
      ...
      >
        {/* Left Column */}
        <div style={{ width: '49%', display: 'flex', flexDirection: 'column', gap: '1.5px' }}>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <span style={{ width: '100px', fontWeight: 900 }}>Date :</span>
            <span style={{ flex: 1, borderBottom: '1px solid #000000', paddingLeft: '4px', fontWeight: 900 }}>{audit.audit_date || 'N/A'}</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <span style={{ width: '100px', fontWeight: 900 }}>Station No. :</span>
            <span style={{ flex: 1, borderBottom: '1px solid #000000', paddingLeft: '4px', fontWeight: 900 }}>{audit.station_no || audit.station_number || 'N/A'}</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <span style={{ width: '100px', fontWeight: 900 }}>Station Name :</span>
            <span style={{ flex: 1, borderBottom: '1px solid #000000', paddingLeft: '4px', fontWeight: 900 }}>{audit.station_name || 'N/A'}</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <span style={{ width: '100px', fontWeight: 900 }}>City / Location :</span>
            <span style={{ flex: 1, borderBottom: '1px solid #000000', paddingLeft: '4px', fontWeight: 900 }}>{audit.location || audit.city || 'N/A'}</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <span style={{ width: '100px', fontWeight: 900 }}>Audit Number :</span>
            <span style={{ flex: 1, borderBottom: '1px solid #000000', paddingLeft: '4px', fontWeight: 900, fontFamily: 'monospace' }}>{audit.audit_number || 'N/A'}</span>
          </div>
        </div>
      ...
      {/* 5. AUTHORIZATION & INSPECTION SIGNATURES (1 HORIZONTAL ROW OF 5 CARDS) */}
      <div style={{ marginTop: '4px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', width: '100%', gap: '4px' }}>
          {/* Station Supervisor */}
          <div style={{ width: '19.2%', border: '1px solid #000000', padding: '3px', height: '52px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backgroundColor: '#ffffff', boxSizing: 'border-box' }}>
            ...
            {audit.station_supervisor_signature_url ? (
              <div style={{ textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <img src={audit.station_supervisor_signature_url} alt="Signature" style={{ maxHeight: '20px', objectFit: 'contain' }} crossOrigin="anonymous" />
          ...
          <div style={{ width: '19.2%', border: '1px solid #000000', padding: '3px', height: '52px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backgroundColor: '#ffffff', boxSizing: 'border-box' }}>
            ...
            {audit.operation_supervisor_signature_url ? (
              <div style={{ textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <img src={audit.operation_supervisor_signature_url} alt="Signature" style={{ maxHeight: '20px', objectFit: 'contain' }} crossOrigin="anonymous" />
          ...
          <div style={{ width: '19.2%', border: '1px solid #000000', padding: '3px', height: '52px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backgroundColor: '#ffffff', boxSizing: 'border-box' }}>
            ...
            {audit.accountant_signature_url ? (
              <div style={{ textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <img src={audit.accountant_signature_url} alt="Signature" style={{ maxHeight: '20px', objectFit: 'contain' }} crossOrigin="anonymous" />
          ...
          <div style={{ width: '19.2%', border: '1px solid #000000', padding: '3px', height: '52px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backgroundColor: '#ffffff', boxSizing: 'border-box' }}>
            ...
            {audit.account_manager_signature_url ? (
              <div style={{ textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <img src={audit.account_manager_signature_url} alt="Signature" style={{ maxHeight: '20px', objectFit: 'contain' }} crossOrigin="anonymous" />
          ...
          <div style={{ width: '19.2%', border: '1px solid #000000', padding: '3px', height: '52px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backgroundColor: '#ffffff', boxSizing: 'border-box' }}>
            ...
            {audit.executive_management_signature_url ? (
              <div style={{ textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <img src={audit.executive_management_signature_url} alt="Signature" style={{ maxHeight: '20px', objectFit: 'contain' }} crossOrigin="anonymous" />
