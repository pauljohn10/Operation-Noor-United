...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    so: {
      ...
      activityLogTitle: 'Head of Operation Activity Log',
      ...
      roleHeadOfOp: 'Head of Operation',
    },
  },
  ...
  ar: {
    ...
    so: {
      ...
      activityLogTitle: 'سجل نشاط رئيس العمليات',
