...
export const SOPdfLayout: React.FC<Props> = ({ form }) => {
  ...
  return (
    ...
    >
      {/* PAGE 2 HEADER TEMPLATE (Hidden by default, cloned dynamically by pdfGenerator if multi-page) */}
      <div
        id="pdf-page2-header-template"
        style={{
          display: 'none',
          borderRadius: '6px',
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            <div style={{ fontSize: '11px', fontWeight: '900', color: '#FFFFFF' }}>
              AL NOOR UNITED FUEL EST. — STATION OPENING FORM
            </div>
            <div style={{ fontSize: '8px', color: '#38BDF8', fontWeight: 'bold' }}>
              Form #: {form.form_number} | Station: {form.station_name}
            </div>
          </div>
        </div>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <div style={{ fontSize: '7.5px', color: '#94A3B8', marginTop: '2px', fontWeight: 'bold' }}>
            Page 2 of 2
          </div>
        </div>
      </div>

      {/* 0. COVER HEADER (Section 00) */}
      <div
      ...
      {/* 1. SECTION 1: STATION BASIC INFORMATION */}
      <div className="pdf-section" data-section="sec1" style={{ marginBottom: '10px', borderRadius: '6px', border: '1px solid #E2E8F0', overflow: 'hidden' }}>
        <div
          style={{
            backgroundColor: '#0F172A',
            color: '#FFFFFF',
      ...
      {/* 2. SECTION 2: FUEL PUMPS & PRODUCT TANKS SPECIFICATIONS */}
      <div className="pdf-section" data-section="sec2" style={{ marginBottom: '10px', borderRadius: '6px', border: '1px solid #E2E8F0', overflow: 'hidden' }}>
        <div
          style={{
            backgroundColor: '#0F172A',
            color: '#FFFFFF',
      ...
      {/* 3. SECTION 3: SAFETY EQUIPMENT & INSPECTION */}
      <div className="pdf-section" data-section="sec3" style={{ marginBottom: '10px', borderRadius: '6px', border: '1px solid #E2E8F0', overflow: 'hidden' }}>
        <div
          style={{
            backgroundColor: '#0F172A',
            color: '#FFFFFF',
      ...
      {/* 4. SECTION 4: FIRE EXTINGUISHERS & SAFETY ITEMS */}
      <div className="pdf-section" data-section="sec4" style={{ marginBottom: '10px', borderRadius: '6px', border: '1px solid #E2E8F0', overflow: 'hidden' }}>
        <div
          style={{
            backgroundColor: '#0F172A',
            color: '#FFFFFF',
      ...
      {/* 5. SECTION 5: OPERATIONAL AMENITIES CHECKLIST */}
      <div className="pdf-section" data-section="sec5" style={{ marginBottom: '10px', borderRadius: '6px', border: '1px solid #E2E8F0', overflow: 'hidden' }}>
        <div
          style={{
            backgroundColor: '#0F172A',
            color: '#FFFFFF',
      ...
      {/* 6. SECTION 6: MANAGEMENT APPROVAL MATRIX & SIGNATURES */}
      <div className="pdf-section" data-section="sec6" style={{ borderRadius: '6px', border: '1px solid #E2E8F0', overflow: 'hidden' }}>
        <div
          style={{
            backgroundColor: '#0F172A',
            color: '#FFFFFF',
