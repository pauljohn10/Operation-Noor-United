...
export const SOPdfLayout: React.FC<Props> = ({ form }) => {
  ...
  return (
    <div id="station-opening-pdf-document" style={{ width: '794px', backgroundColor: '#FFFFFF', margin: '0 auto' }}>
      {/* =================================================================================== */}
      {/* PAGE 1: COVER HEADER + SECTIONS 01, 02, 03 */}
      {/* =================================================================================== */}
      <div
        className="pdf-page"
        style={{
      ...
      >
        ...
        >
          <div>Page 1 of 2 — Al Noor United Fuel Est. Official Report</div>
          <div>Station: <span style={{ fontWeight: 'bold', color: '#0F172A' }}>{form.station_name} ({form.station_no})</span></div>
        </div>
      </div>

      {/* =================================================================================== */}
      {/* PAGE 2: SECOND HEADER + SECTIONS 04, 05, 06 SIGNATURES */}
      {/* =================================================================================== */}
      <div
        className="pdf-page"
        style={{
        ...
        <div style={{ borderRadius: '6px', border: '1px solid #E2E8F0', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '8px 12px' }}>
            ...
            >
              ...
              <div>
                Generated on: <span style={{ fontWeight: 'bold', color: '#0F172A' }}>{new Date().toISOString().split('T')[0]}</span> | Page 2 of 2
              </div>
            </div>
          </div>
        </div>
